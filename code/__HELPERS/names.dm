...
/proc/new_station_name()
	...
	//Rare: Pre-Prefix
	if (prob(10))
		name = pick("Totally Bunkerstation:", "Not Actually Bunkerstation:", "Could Be Bunkerstation:") //"Imperium", "Heretical", "Cuban", "Psychic", "Elegant", "Common", "Uncommon", "Rare", "Unique", "Houseruled", "Religious", "Atheist", "Traditional", "Houseruled", "Mad", "Super", "Ultra", "Secret", "Top Secret", "Deep", "Death", "Zybourne", "Central", "Main", "Government", "Uoi", "Fat", "Automated", "Experimental", "Augmented")
		station_name = name + " "
	...
	switch(Holiday)
		//get normal name
		if(null,"",0)
			name = pick("Bunkerstation:")//"", "Stanford", "Dorf", "Alium", "Prefix", "Clowning", "Aegis", "Ishimura", "Scaredy", "Death-World", "Mime", "Honk", "Rogue", "MacRagge", "Ultrameens", "Safety", "Paranoia", "Explosive", "Neckbear", "Donk", "Muppet", "North", "West", "East", "South", "Slant-ways", "Widdershins", "Rimward", "Expensive", "Procreatory", "Imperial", "Unidentified", "Immoral", "Carp", "Ork", "Pete", "Control", "Nettle", "Aspie", "Class", "Crab", "Fist","Corrogated","Skeleton","Race", "Fatguy", "Gentleman", "Capitalist", "Communist", "Bear", "Beard", "Derp", "Space", "Spess", "Star", "Moon", "System", "Mining", "Neckbeard", "Research", "Supply", "Military", "Orbital", "Battle", "Science", "Asteroid", "Home", "Production", "Transport", "Delivery", "Extraplanetary", "Orbital", "Correctional", "Robot", "Hats", "Pizza")
			if(name)
				station_name += name + " "

		//For special days like christmas, easter, new-years etc ~Carn
		//if("Friday the 13th")
			//name = pick("Spooky Bunkerstation:")//"Mike","Friday","Evil","Myers","Murder","Deathly","Stabby")
			//station_name += name + " "
			//random = 13
		//else
	...
	// Suffix
	name = pick("Edition", "You're Here Forever", "Bunkerstation", "Inside Jokes", "Metro", "RNGesus", "We Can't Have Nice Things", "Shitty Skills", "SS13 Rippoff", "AAAAAAAAA", "Metro Memes", "Not Fallout", "Fix Your Fucking Game" )//"Station", "Fortress", "Frontier", "Suffix", "Death-trap", "Space-hulk", "Lab", "Hazard","Spess Junk", "Fishery", "No-Moon", "Tomb", "Crypt", "Hut", "Monkey", "Bomb", "Trade Post", "Fortress", "Village", "Town", "City", "Edition", "Hive", "Complex", "Base", "Facility", "Depot", "Outpost", "Installation", "Drydock", "Observatory", "Array", "Relay", "Monitor", "Platform", "Construct", "Hangar", "Prison", "Center", "Port", "Waystation", "Factory", "Waypoint", "Stopover", "Hub", "HQ", "Office", "Object", "Fortification", "Colony", "Planet-Cracker", "Roost", "Fat Camp")
	station_name += name + " " + "Edition"
